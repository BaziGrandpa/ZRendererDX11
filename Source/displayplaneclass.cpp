...
{
    DisplayPlaneClass::VertexType* vertices;
    ...
    vertices = new DisplayPlaneClass::VertexType[m_vertexCount];
    ...
    vertexBufferDesc.ByteWidth = sizeof(DisplayPlaneClass::VertexType) * m_vertexCount;
...
void DisplayPlaneClass::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
    ...
    stride = sizeof(DisplayPlaneClass::VertexType);
    offset = 0;
